	...
	<div class="content clearfix">
		<div class="main">
			...
			<?php endforeach;?>
								...
								<tr>
									<td colspan="2">商品链接</td>
									<td><input type="text" name="pUrl" value="http://<?php echo $proInfo['pUrl'];?>" /></td>
								</tr>
								<tr>
									<td colspan="2">商品产地</td>
									<td><input type="text" name="address" value="<?php echo $proInfo['address'];?>" /></td>
								</tr>
								<tr>
									<td colspan="2">打折前价格</td>
									<td><input type="text" name="mPrice" value="<?php echo $proInfo['bPrice'];?>" /></td>
								</tr>
								<tr>
									<td colspan="2">打折后价格</td>
									<td><input type="text" name="iPrice" value="<?php echo $proInfo['nPrice'];?>" /></td>
								</tr>
								<tr>
									<td colspan="2">商品描述</td>
									<td><textarea name="pDesc" id="editor_id"
											style="width: 100%; height: 150px;"><?php echo $proInfo['pTitle']?></textarea></td>
								</tr>
