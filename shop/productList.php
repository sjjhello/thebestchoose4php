...
//得到所有商品
$sql = "select id,pName,pTitle,pUrl,pic_url,bPrice,nPrice from bs_pro";
...
$sql = "select id,pName,pTitle,pUrl,bPrice,pic_url,nPrice from bs_pro limit {$offset},{$pageSize}";
$alls = fetchAll($sql);
//print_r($alls);
?>
<!DOCTYPE html>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="single-shop-product">
                    <div class="product-upper" height="262.5" width="262.5">
                        <img src="<?php echo $all['pic_url'] ?>" alt="" height="262.5" width="262.5">
                    </div>
            ...
            <div class="col-md-12">
                <div class="product-pagination text-center">
                    <nav>
                        <ul class="pagination">
                            <li>
                                <a href="<?php echo "{$url}?page={$prevPage}" ?>" aria-label="Previous">
                            ...
                            <?php endfor?>
                            <li>
                                <a href="<?php echo "{$url}?page={$nextPage}" ?>" aria-label="Next">
